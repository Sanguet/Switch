...
public class asdasdas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (rSTableMetroCustom2.getColumnModel().getColumnCount() > 0) {
            ...
            rSTableMetroCustom2.getColumnModel().getColumn(2).setResizable(false);
            rSTableMetroCustom2.getColumnModel().getColumn(3).setResizable(false);
            rSTableMetroCustom2.getColumnModel().getColumn(4).setResizable(false);
        }
