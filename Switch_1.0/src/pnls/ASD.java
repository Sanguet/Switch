...
public class ASD extends javax.swing.JPanel {
    ...
    public ASD() {
        ...
        try{
            ...
            jtEmail.setText("Pedro");
            jtMetodo_de_pago.setText("Pedro");
            jlSaldo.setText("0");
    ...
    private void initComponents() {
        ...
        jtBoxxx = new javax.swing.JTextField();
        ...
        jtBoxxx.setText("jTextField1");
        form.add(jtBoxxx, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 240, 30));
    ...
    private void jbEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEditarActionPerformed
        ...
        if(JOptionPane.YES_OPTION == msj){
            try{
                ...
                Cliente cliente = new Cliente(jlNombre.getText(), Long.parseLong(jtTelefono.getText()), jtEmail.getText(), jtBoxxx.getText(), jtMetodo_de_pago.getText(), jtaComentario.getText());
    ...
    private javax.swing.JTextField jtBoxxx;
